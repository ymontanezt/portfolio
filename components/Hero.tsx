...
export default function Hero({ name, role, tagline, photoUrl }: HeroProps) {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center px-4 py-20 pt-32 relative">
          ...
          >
            ...
            >
              <Button
                ...
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-3 text-lg font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl"
              >
            ...
            >
              <Button
                onClick={() => window.open('https://linkedin.com/in/yuri-michael-montañez-tuncar-39744496', '_blank')}
                size="lg"
                variant="outline"
                className="border-primary text-primary hover:bg-primary/10 hover:border-primary/80 px-8 py-3 text-lg font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl"
              >
